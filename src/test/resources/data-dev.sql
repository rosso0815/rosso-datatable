...
insert into j5s_bundle(id,environment,name,swid,version) values (1,'TE1','GSM_BUNDLE1','GSM','1.0.0');



---INSERT INTO swid( id, swid ) values (1, 'AAA' );
---INSERT INTO swid( id, swid ) values (2, 'BBB' );

---INSERT INTO rfc( id, number, start, finish, remark, active) values (1,222 , CURRENT_DATE(), CURRENT_DATE(), 'remark' , true);
