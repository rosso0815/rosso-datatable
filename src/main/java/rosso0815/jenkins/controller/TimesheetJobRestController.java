...
import rosso0815.jenkins.repository.TimesheetJobRepository;
import rosso0815.jenkins.repository.TimesheetRepository;

@RestController
@RequestMapping("api/timesheetjob")
public class TimesheetJobRestController {

	private final static Logger log = Logger.getLogger(TimesheetJobRestController.class.getName());
...
//	// curl http://localhost:8080/api/rfc
	...
	@ResponseBody
	public List<TimesheetJob> retrieveAllTimeSheetJobs() {
		log.info("retrieveAllTimeSheetJobs");
		return tsJobRepo.findAll();
	}
