---
insert into ts_timesheet ( ts_id , active , start , finish , remark , number ) values ( 1 , true , CURRENT_TIMESTAMP() , CURRENT_TIMESTAMP( ), 'remark 1' , 1 );
insert into ts_timesheet ( ts_id , active , start , finish , remark , number ) values ( 2 , true , CURRENT_TIMESTAMP() , CURRENT_TIMESTAMP( ), 'remark 2' , 2 );
